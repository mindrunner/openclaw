...
#
# When PostgreSQL is installed in the image (OPENCLAW_INSTALL_POSTGRESQL=1),
# this entrypoint initializes and starts the PostgreSQL service before
# handing off to the main process (the OpenClaw gateway).
#
